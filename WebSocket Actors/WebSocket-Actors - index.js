 ...
 * https://github.com/Innova4DLab/websocket-play-actors
 ...
 *
 * El mensaje contiene la siguiente estructura:
 * Usuario #(numUsuario) dice: (mensaje) (horaMensaje)
 * siendo las palabras entre paréntesis, variables con el contenido correspondiente
 */
$(function() {
  var ws;
  ...
  ws.onmessage = function(event) {
    ...
    switch (message.type) {
      case "message":
        return $("#board tbody").append(
          //Estructura del mensaje: Usuario #(numUsuario) dice: (mensaje) (horaMensaje)
          "<tr><td class='user'>Usuario#"+ message.uid +" dice:</td><td>"+ message.msg +
          "</td><td class='timestamp'>"+message.timestamp+"</td></tr>");
      default:
